...
3. Модернизировал  [gitlab-ci.yaml](cicd%2Fgitlab-ci.yaml) - теперь сборка при коммите, деплой только при тэгировании. Добавил в репозиторий [app.yaml](cicd/app.yaml) с указанием версии приложения.
4. Можно разместить все конфиги в GITLAB для первого деплоя инфраструктуры. Затем настроить ci/cd в тех же репозиториях. И произвести деплой приложения.
